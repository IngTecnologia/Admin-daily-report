        ...
        <div className="form-field">
          ...
          {formData.cantidad_ingresos_retiros > 0 && (
            <div style={{
              ...
              =Ý Se generarán {formData.cantidad_ingresos_retiros} formularios de movimiento
            </div>
          )}
        </div>
      </div>
      ...
      {formData.cantidad_ingresos_retiros > 0 && (
        <div className="dynamic-section">
          <h3 style={{ 
            ...
            =e Movimientos de Personal ({formData.cantidad_ingresos_retiros})
          </h3>
                  ...
                  <div style={{ 
                    ...
                    <div>
                      <strong style={{ color: 'var(--error-red)' }}>
                        L Retiros: {formData.ingresos_retiros.filter(mov => mov && mov.estado === 'Retiro').length}
                      </strong>
                    </div>
                  </div>
